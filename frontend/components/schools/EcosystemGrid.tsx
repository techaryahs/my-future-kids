...
const solutions = [
  {
    ...
    tag: "Build",
    href: "/school-solutions#robotics-education",
  },
  {
    icon: FlaskConical,
    title: "STEM Learning",
    ...
    tag: "Explore",
    href: "/school-solutions#stem-learning",
  },
  {
    icon: BrainCircuit,
    ...
    tag: "Discover",
    href: "/school-solutions#artificial-intelligence",
  },
  {
    icon: Code2,
    ...
    tag: "Create",
    href: "/school-solutions#coding-programs",
  },
  {
    icon: Glasses,
    ...
    tag: "Experience",
    href: "/school-solutions#ar-vr-learning",
  },
  {
    icon: Lightbulb,
    ...
    tag: "Innovate",
    href: "/school-solutions#innovation-programs",
  },
];
            ...
            return (
              <Link key={solution.title} href={solution.href} className="block">
                <motion.div
                  ...
                  className="group relative overflow-hidden rounded-3xl border border-slate-100 bg-white p-7 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:border-blue-100 hover:shadow-2xl h-full"
                >
                  {/* Decorative circle */}
