...
export default function SchoolSolutionsPage() {
  return (
    <main className="min-h-screen bg-white text-gray-950">
      {/* HERO */}
      <section className="relative overflow-hidden bg-gray-950 px-6 py-24 text-white lg:px-10 lg:py-32">
        <div className="mx-auto max-w-7xl">
          <div className="max-w-4xl">
            ...
            <div className="mt-10 flex flex-col gap-3 sm:flex-row">
              <Link
                href="/schools"
                className="rounded-full bg-white px-7 py-4 text-center text-sm font-semibold text-gray-950 transition hover:-translate-y-1"
              >
                ← Back to Schools
              </Link>
      ...
      {/* CUSTOMIZATION */}
      <section className="px-6 py-24 lg:px-10">
        <div className="mx-auto max-w-7xl rounded-[2.5rem] bg-gray-950 px-8 py-16 text-white md:px-16 md:py-20">
