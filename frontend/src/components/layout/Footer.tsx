        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="#" className="text-sm text-slate-600 hover:text-blue-600 transition-colors">About Us</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 mb-6">
              ...
              <li><Link href="#" className="text-sm text-slate-600 hover:text-blue-600 transition-colors">Book a Demo</Link></li>
            </ul>
