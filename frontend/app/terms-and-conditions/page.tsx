...
export default function TermsAndConditionsPage() {
  return (
    <div className="bg-slate-50 dark:bg-[#090d16] min-h-screen py-24 text-slate-900 dark:text-slate-100">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <div className="bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-500 dark:border-amber-400 p-4 mb-8 rounded-r-lg">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-800 p-5 sm:p-8 md:p-12">
          <header className="mb-12 border-b border-slate-100 dark:border-slate-800 pb-8">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-slate-900 dark:text-white mb-4">Terms & Conditions</h1>
            <p className="text-base sm:text-lg text-slate-600 dark:text-slate-300 mb-4">Rules and guidelines for using the BeFutureKids platform.</p>
            <p className="text-sm font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider">Last Updated: September 2026</p>
          </header>
          ...
          <div className="space-y-8 text-slate-600 dark:text-slate-300">
            ...
            <div>
              <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-3">3. Educational Information</h2>
              <p className="leading-relaxed">
            ...
            <div>
              <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-3">4. Bookings and Enquiries</h2>
              <p className="leading-relaxed">
            ...
            <div>
              <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-3">5. Programs and Services</h2>
              <p className="leading-relaxed">
            ...
            <div>
              <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-3">9. Changes to Website</h2>
              <p className="leading-relaxed">
            ...
            <div>
              ...
              <p className="leading-relaxed">
                ...
                <br/><em className="text-sm text-slate-500 dark:text-slate-400 mt-2 block">TODO for legal review: Update with specific governing law jurisdiction.</em>
              </p>
            </div>
            ...
            <div>
              ...
              <div className="bg-slate-50 dark:bg-slate-800/60 p-6 rounded-xl border border-slate-200 dark:border-slate-700 mt-6">
                <p className="font-medium text-slate-900 dark:text-white mb-1">BeFutureKids Legal Team</p>
                <p className="text-slate-600 dark:text-slate-300 mb-1"><strong className="text-slate-700 dark:text-slate-200">Email:</strong> [INSERT OFFICIAL EMAIL]</p>
                <p className="text-slate-600 dark:text-slate-300"><strong className="text-slate-700 dark:text-slate-200">Phone:</strong> [INSERT OFFICIAL PHONE]</p>
              </div>
            </div>
